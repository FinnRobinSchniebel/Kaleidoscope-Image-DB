...
export default function ImageSetDialog({imageSets, index} : Props){
    ...
    return (
        <DialogContent className='overflow-hidden bg-background/40 text-primary rounded-2 p-0 gap-0 m-0 h-dvh w-full xl:w-[80%] flex ' OverlayClassName='bg-black/40 backdrop-blur-[2px]'  onInteractOutside={(e) => e.preventDefault()}>
